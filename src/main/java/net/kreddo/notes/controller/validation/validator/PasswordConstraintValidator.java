package net.kreddo.notes.controller.validation.validator;
...
public class PasswordConstraintValidator implements ConstraintValidator<ValidPassword, String> {
  ...
  public void initialize(ValidPassword constraintAnnotation) {
    try {
      String invalidPasswordList = this.getClass().getResource(
          "/validation/invalid-password-list.txt").getFile();
